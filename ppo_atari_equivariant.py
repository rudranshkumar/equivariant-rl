...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        layer1_type = enn.FieldType(r2_act, 32*[r2_act.regular_repr])
        layer2_type = enn.FieldType(r2_act, 64*[r2_act.regular_repr])
        layer3_type = enn.FieldType(r2_act, 64*[r2_act.regular_repr])
        layer4_type = enn.FieldType(r2_act, 512*[r2_act.regular_repr])
        ...
        self.critic = nn.Sequential(
                enn.R2Conv(layer4_type, critic_out_type, kernel_size=1, stride=1, initialize=True),
        )
